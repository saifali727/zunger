...
class CommentController extends Controller
{
    ...
    public function comment(Request $request)
    {
        ...
        if($request->hasFile('media')){
            ...
            $request['url']= 'https://duai0zal0fg0e.cloudfront.net/'.$urls3;
            ...
            ->toDisk('s3')
            ->save($outputPath);
            $request['thumbnail'] = 'https://duai0zal0fg0e.cloudfront.net/'.$outputPath;
        }
        ...
        try{
            ...
            return response()->json([
                ...
                'comment' => $comments,
                'thumbnail'=>$outputPath ? 'https://duai0zal0fg0e.cloudfront.net/'.$outputPath : '' ,
            ]);
        }
    ...
    public function edit_comment(Request $request){
        ...
        if($request->hasFile('media')){
            ...
            $url_update = 'https://duai0zal0fg0e.cloudfront.net/'.$url; // Uncomment this line
