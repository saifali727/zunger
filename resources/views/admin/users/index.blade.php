...
@push('start-script')
    ...
    <script>
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            swal.fire("Success", " Seller delted successfully", "success");
                        },
                    ...
                    Swal.fire('Seller not deleted', '', 'info')
                }
            });
        ...
        function change_status(id) {
            swal.fire({
                title: "Are you sure?",
                text: "Seller may not be able to sell product any more if disabled!",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#default-ordering').DataTable().ajax.reload();
                            swal.fire("Success", " Seller status change successfully", "success");
                        },
                        error: function(error) {
                            Snackbar.show({
                                text: 'Server error',
